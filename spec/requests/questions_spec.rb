...
RSpec.describe "Questions", type: :request do
  ...
  describe 'POST /questions' do
    # valid payload
    let(:valid_attributes) { { q_text: 'How old are you?', image: 'www.example.com/image.png' } }

    context 'when the request is valid' do
      before { post '/questions', params: valid_attributes }

      it 'creates a question' do
        expect(json['q_text']).to eq('How old are you?')
        expect(json['image']).to eq('www.example.com/image.png')
      end
    ...
    context 'when the request is invalid' do
      before { post '/questions', params: { q_text: 'Question' } }
  ...
  describe 'PUT /questions/:id' do
    let(:valid_attributes) { { q_text: 'Shopping' } }
